                ...
                <div class="pagePane-container">
                    ...
                    <div class="rowBox" style="margin-bottom:12px;">
                        <div class="row" style="margin-right:20px;">
                            <info-window style="margin-top:0;" infoWidth="100%" infoHeight="320px" headerTitle="产量异常归因分析" isShowMaxBtn>
                                <div slot-name="titleContent">
                                    <el-button type="primary" style="position: absolute;right:50px;top:6px;height:30px;" @click="downTable('#table1','产量异常归因分析')">下载</el-button>
                                </div>
                                <el-table 
                                    id="table1" 
                    ...
                    <div class="rowBox">
                        <div class="row" style="margin-right:20px;">
                            <info-window style="margin-top:0;" infoWidth="100%" infoHeight="440px" :headerTitle="tabsName" isShowMaxBtn>
                                <div slot-name="titleContent">
                                    <el-button type="primary" style="position: absolute;right:50px;top:6px;height:30px;" @click="downTable('#table2',tabsName)">下载</el-button>
                                </div>
                                <el-table 
                                    id="table2" 
                                    :data="tabTableData" 
                                	...
                                	<el-table-column label="当日生产情况">
                                		<el-table-column prop="proTime" label="生产时间"></el-table-column>
                                		<el-table-column prop="liquidDaily" label="日产液量"></el-table-column>
                                		<el-table-column prop="oilDaily" label="日产油量"></el-table-column>
                                		<el-table-column prop="waterCut" label="含水率"></el-table-column>
                                		<el-table-column prop="pumpPressure" label="泵入口压力"></el-table-column>
                                	</el-table-column>
                                	<el-table-column label="昨日生产情况">
                                		<el-table-column prop="proTimeYesterday" label="生产时间"></el-table-column>
                                		<el-table-column prop="liquidDailyYesterday" label="日产液量"></el-table-column>
                                		<el-table-column prop="oilDailyYesterday" label="日产油量"></el-table-column>
                                		<el-table-column prop="waterCutYesterday" label="含水率"></el-table-column>
                                		<el-table-column prop="pumpPressureYesterday" label="泵入口压力"></el-table-column>
                                	</el-table-column>
                                	<el-table-column label="差值">
                                		<el-table-column prop="liquidDailyDiff" label="日产液量"></el-table-column>
                                		<el-table-column prop="oilDailyDiff" label="日产油量"></el-table-column>
                                		<el-table-column prop="waterCutDiff" label="含水率"></el-table-column>
                                		<el-table-column prop="pumpPressureDiff" label="泵入口压力"></el-table-column>
                                	</el-table-column>
