            ...
            <pagePanelNew class="pagePanelNew">
                <div class="pagePane-container">
                    ...
                    <div class="rowBox" style="margin-bottom:20px;" v-if="!isShowTable">
                                        ...
                                        <el-col :span="12" style="height: 100%;">
                                            <div align="center" style="height: 100%;display: flex;align-items: center;justify-content: center;">
                                                <el-card class="cardLeft" shadow="always">
                                                    {{ realOutput }}
                                                    <span>
                                                        <svg-icon v-if="realOutputFlag == 'UP'" icon-class="0-down-arrow" class-name="up-arrow"></svg-icon>
                                                        <svg-icon v-if="realOutputFlag == 'DOWN'" icon-class="0-down-arrow" class-name="down-arrow"></svg-icon>
                                                    </span>
                                                </el-card>
                                            </div>
                                        </el-col>
                        ...
                        <div class="row" style="margin-right:20px;">
                            <info-window style="margin-top:0;" infoWidth="100%" infoHeight="400px" headerTitle="平台产量组成" isShowMaxBtn>
                                <div class="row-container">
            ...
            <div style="margin-top: 10px">
                <el-table :data="outputTrackingTableData" highlight style="width:100%;" height="500px">
                    ...
                    <el-table-column label="QHD32-6" align="center">
                        <el-table-column prop="seljc" label="基础" align="center" width="100">
                        </el-table-column>
                        <el-table-column prop="selcs" label="措施" align="center" width="100">
                        </el-table-column>
                        <el-table-column prop="seltz" label="调整井" align="center" width="100">
                        </el-table-column>
                        <el-table-column prop="selhj" label="合计" align="center" width="100">
                        </el-table-column>
                    </el-table-column>
                    <el-table-column label="BZ25-1" align="center">
                        <el-table-column prop="ewyjc" label="基础" align="center" width="100">
                        </el-table-column>
                        <el-table-column prop="ewycs" label="措施" align="center" width="100">
                        </el-table-column>
                        <el-table-column prop="ewytz" label="调整井" align="center" width="100">
                        </el-table-column>
                        <el-table-column prop="ewyhj" label="合计" align="center" width="100">
                        </el-table-column>
                    </el-table-column>
                    <el-table-column label="BZ25-1S" align="center">
                        <el-table-column prop="ewysjc" label="基础" align="center" width="100">
                        </el-table-column>
                        <el-table-column prop="ewyscs" label="措施" align="center" width="100">
                        </el-table-column>
                        <el-table-column prop="ewystz" label="调整井" align="center" width="100">
                        </el-table-column>
                        <el-table-column prop="ewyshj" label="合计" align="center" width="100">
                        </el-table-column>
                    </el-table-column>
                    <el-table-column label="BZ19-4" align="center">
                        <el-table-column prop="yjsjc" label="基础" align="center" width="100">
                        </el-table-column>
                        <el-table-column prop="yjscs" label="措施" align="center" width="100">
                        </el-table-column>
                        <el-table-column prop="yjstz" label="调整井" align="center" width="100">
                        </el-table-column>
                        <el-table-column prop="yjskf" label="开发井" align="center" width="100">
                        </el-table-column>
                        <el-table-column prop="yjshj" label="合计" align="center" width="100">
                        </el-table-column>
                        <el-table-column prop="bzhj" label="BZ合计" align="center" width="100">
                        </el-table-column>
                    </el-table-column>
                </el-table>
            </div>
        ...
        methods: {
            ...
            async initData() {
                await fetchOilFields().then((res) => {
                    ...
                    this.oilFieldName = this.oilField[0].name;
                });
            ...
            dealOutputTrackingData(objData) {
                ...
                keys.forEach((item, index) => {
                    ...
                    if (lineTitle != null && lineTitle != '') {
                        var lineObj = {
                            'type': lineTitle,
                            'code': item,
                            'zygsjc': (objData[item]['QHD32-6']['jiChu'] == null && objData[item]['BZ25-1']['jiChu'] == null && objData[item]['BZ25-1S']['jiChu'] == null && objData[item]['BZ19-4']['jiChu'] == null) ? '' : ((
                                ...
                                (objData[item]['BZ19-4']['jiChu'] ? parseFloat(objData[item]['BZ19-4']['jiChu']) : 0)).toFixed(2),
                            'zygscs': (objData[item]['QHD32-6']['cuoShi'] == null && objData[item]['BZ25-1']['cuoShi'] == null && objData[item]['BZ25-1S']['cuoShi'] == null && objData[item]['BZ19-4']['cuoShi'] == null) ? '' : ((
                                ...
                                (objData[item]['BZ19-4']['cuoShi'] ? parseFloat(objData[item]['BZ19-4']['cuoShi']) : 0)).toFixed(2),
                            'zygstz': (objData[item]['QHD32-6']['tiaoZheng'] == null && objData[item]['BZ25-1']['tiaoZheng'] == null && objData[item]['BZ25-1S']['tiaoZheng'] == null && objData[item]['BZ19-4']['tiaoZheng'] ==
                                null) ? '' : ((objData[item]['QHD32-6']['tiaoZheng'] ? parseFloat(objData[item]['QHD32-6']['tiaoZheng']) : 0) +
                                ...
                                (objData[item]['BZ19-4']['tiaoZheng'] ? parseFloat(objData[item]['BZ19-4']['tiaoZheng']) : 0)).toFixed(2),
                            'zygskf': objData[item]['BZ19-4']['kaiFa'] ? parseFloat(objData[item]['BZ19-4']['kaiFa'].toFixed(2)) : '',
                            'zygshj': (objData[item]['QHD32-6']['jiChu'] == null && objData[item]['BZ25-1']['jiChu'] == null && objData[item]['BZ25-1S']['jiChu'] == null && objData[item]['BZ19-4']['jiChu'] == null &&
                                objData[item]['QHD32-6']['cuoShi'] == null && objData[item]['BZ25-1']['cuoShi'] == null && objData[item]['BZ25-1S']['cuoShi'] == null && objData[item]['BZ19-4']['cuoShi'] == null &&
                                objData[item]['QHD32-6']['tiaoZheng'] == null && objData[item]['BZ25-1']['tiaoZheng'] == null && objData[item]['BZ25-1S']['tiaoZheng'] == null && objData[item]['BZ19-4']['tiaoZheng'] ==
                                null &&
                                objData[item]['BZ19-4']['kaiFa'] == null) ? '' : ((objData[item]['QHD32-6']['jiChu'] ? parseFloat(objData[item]['QHD32-6']['jiChu']) : 0) +
                                (objData[item]['BZ25-1']['jiChu'] ? parseFloat(objData[item]['BZ25-1']['jiChu']) : 0) +
                                (objData[item]['BZ25-1S']['jiChu'] ? parseFloat(objData[item]['BZ25-1S']['jiChu']) : 0) +
                                ...
                                (objData[item]['BZ19-4']['kaiFa'] ? parseFloat(objData[item]['BZ19-4']['kaiFa']) : 0)).toFixed(2),
                            ...
                            'seltz': objData[item]['QHD32-6']['tiaoZheng'] ? parseFloat(objData[item]['QHD32-6']['tiaoZheng'].toFixed(2)) : '',
                            'selhj': (objData[item]['QHD32-6']['jiChu'] == null && objData[item]['QHD32-6']['cuoShi'] == null && objData[item]['QHD32-6']['tiaoZheng'] == null) ? '' : ((objData[item]['QHD32-6']['jiChu'] ?
                                    parseFloat(objData[item]['QHD32-6']['jiChu']) : 0) +
                                (objData[item]['QHD32-6']['cuoShi'] ? parseFloat(objData[item]['QHD32-6']['cuoShi']) : 0) +
                                (objData[item]['QHD32-6']['tiaoZheng'] ? parseFloat(objData[item]['QHD32-6']['tiaoZheng']) : 0)).toFixed(2),
                            ...
                            'ewytz': objData[item]['BZ25-1']['tiaoZheng'] ? parseFloat(objData[item]['BZ25-1']['tiaoZheng'].toFixed(2)) : '',
                            'ewyhj': (objData[item]['BZ25-1']['jiChu'] == null && objData[item]['BZ25-1']['cuoShi'] == null && objData[item]['BZ25-1']['tiaoZheng'] == null) ? '' : ((objData[item]['BZ25-1']['jiChu'] ? parseFloat(
                                    objData[item]['BZ25-1']['jiChu']) : 0) +
                                (objData[item]['BZ25-1']['cuoShi'] ? parseFloat(objData[item]['BZ25-1']['cuoShi']) : 0) +
                                (objData[item]['BZ25-1']['tiaoZheng'] ? parseFloat(objData[item]['BZ25-1']['tiaoZheng']) : 0)).toFixed(2),
                            ...
                            'ewystz': objData[item]['BZ25-1S']['tiaoZheng'] ? parseFloat(objData[item]['BZ25-1S']['tiaoZheng'].toFixed(2)) : '',
                            'ewyshj': (objData[item]['BZ25-1S']['jiChu'] == null && objData[item]['BZ25-1S']['cuoShi'] == null && objData[item]['BZ25-1S']['tiaoZheng'] == null) ? '' : ((objData[item]['BZ25-1S']['jiChu'] ?
                                    parseFloat(objData[item]['BZ25-1S']['jiChu']) : 0) +
                                (objData[item]['BZ25-1S']['cuoShi'] ? parseFloat(objData[item]['BZ25-1S']['cuoShi']) : 0) +
                                (objData[item]['BZ25-1S']['tiaoZheng'] ? parseFloat(objData[item]['BZ25-1S']['tiaoZheng']) : 0)).toFixed(2),
                            ...
                            'yjstz': objData[item]['BZ19-4']['tiaoZheng'] ? parseFloat(objData[item]['BZ19-4']['tiaoZheng'].toFixed(2)) : '',
                            'yjskf': objData[item]['BZ19-4']['kaiFa'] ? parseFloat(objData[item]['BZ19-4']['kaiFa'].toFixed(2)) : '',
                            'yjshj': (objData[item]['BZ19-4']['jiChu'] == null && objData[item]['BZ19-4']['cuoShi'] == null && objData[item]['BZ19-4']['tiaoZheng'] == null && objData[item]['BZ19-4']['kaiFa'] == null) ? '' : ((
                                    objData[item]['BZ19-4']['jiChu'] ? parseFloat(objData[item]['BZ19-4']['jiChu']) : 0) +
                                (objData[item]['BZ19-4']['cuoShi'] ? parseFloat(objData[item]['BZ19-4']['cuoShi']) : 0) +
                                (objData[item]['BZ19-4']['tiaoZheng'] ? parseFloat(objData[item]['BZ19-4']['tiaoZheng']) : 0) +
                                (objData[item]['BZ19-4']['kaiFa'] ? parseFloat(objData[item]['BZ19-4']['kaiFa']) : 0)).toFixed(2),
                            'bzhj': (objData[item]['BZ25-1']['jiChu'] == null &&
                                ...
                                objData[item]['BZ19-4']['kaiFa'] == null) ? '' : ((objData[item]['BZ25-1']['jiChu'] ? parseFloat(objData[item]['BZ25-1']['jiChu']) : 0) +
                                (objData[item]['BZ25-1S']['jiChu'] ? parseFloat(objData[item]['BZ25-1S']['jiChu']) : 0) +
                                (objData[item]['BZ19-4']['jiChu'] ? parseFloat(objData[item]['BZ19-4']['jiChu']) : 0) +
                                (objData[item]['BZ25-1']['cuoShi'] ? parseFloat(objData[item]['BZ25-1']['cuoShi']) : 0) +
                                (objData[item]['BZ25-1S']['cuoShi'] ? parseFloat(objData[item]['BZ25-1S']['cuoShi']) : 0) +
                ...
                var obj = {
                    ...
                    'ewysjc': (today['ewysjc'] == '' && yesterday['ewysjc'] == '') ? '' : (today['ewysjc'] - yesterday['ewysjc']).toFixed(2),
                    'ewyscs': (today['ewyscs'] == '' && yesterday['ewyscs'] == '') ? '' : (today['ewyscs'] - yesterday['ewyscs']).toFixed(2),
                    'ewystz': (today['ewystz'] == '' && yesterday['ewystz'] == '') ? '' : (today['ewystz'] - yesterday['ewystz']).toFixed(2),
                    'ewyshj': (today['ewyshj'] == '' && yesterday['ewyshj'] == '') ? '' : (today['ewyshj'] - yesterday['ewyshj']).toFixed(2),
            ...
            searchThing() {
                ...
                let unitType = this.selectUnitOfProduction;
                //对应id的油田名称
                let fieldContent = this.oilField.find(
                    (item) => item.oilFieldId == oilFieldId
                );
                //存在油田名称
