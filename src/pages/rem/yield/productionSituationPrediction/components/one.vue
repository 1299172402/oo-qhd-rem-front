  ...
  <div class="z-main" style="height: 100%">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px">
      <div>
        <span>滚动预测：</span>
        <el-select
          v-model="searchForm.rollingForecastDate"
          placeholder="请选择"
          style="width: 200px; margin-right: 15px"
        >
          <el-option
            v-for="item in rollingForecastDateList"
            :key="item.source_ID"
      ...
      <el-button
        ...
        @click="doDownExcel('#tableData', '作业公司产量跟踪')"
        >下载</el-button
      >
    </div>
    <el-table id="tableData" :data="tableData" highlight style="width: 100%" height="calc(100% - 58px)">
      ...
      <el-table-column label="QHD33-1S" align="center">
        <el-table-column prop="qhd331sjc" label="基础井" align="center" width="100" :formatter="toPrecise2">
        </el-table-column>
  ...
  methods: {
    ...
    dealOutputTrackingData(objData) {
      ...
      keys.forEach((item, index) => {
        ...
        if (lineTitle != null && lineTitle != "") {
          ...
          let lineObj = {
            ...
            qhd326kf: objData[item]["QHD32-6"]["kaiFa"] ? objData[item]["QHD32-6"]["kaiFa"] : "",
            ...
            nb352kf: objData[item]["NB35-2"]["kaiFa"] ? objData[item]["NB35-2"]["kaiFa"] : "",
            ...
            qhd331skf: objData[item]["QHD33-1S"]["kaiFa"] ? objData[item]["QHD33-1S"]["kaiFa"] : "",
            ...
            cfd64kf: objData[item]["CFD6-4"]["kaiFa"] ? objData[item]["CFD6-4"]["kaiFa"] : "",
            ...
            bz32kf: objData[item]["BZ3-2"]["kaiFa"] ? objData[item]["BZ3-2"]["kaiFa"] : "",
      ...
      var obj = {
        ...
        qhd326kf:
          today["qhd326kf"] == "" && yesterday["qhd326kf"] == ""
            ? ""
            : (today["qhd326kf"] - yesterday["qhd326kf"]).toFixed(2),
        qhd326hj:
        ...
        nb352kf:
          today["nb352kf"] == "" && yesterday["nb352kf"] == ""
            ? ""
            : (today["nb352kf"] - yesterday["nb352kf"]).toFixed(2),
        nb352hj:
        ...
        qhd331skf:
          today["qhd331skf"] == "" && yesterday["qhd331skf"] == ""
            ? ""
            : (today["qhd331skf"] - yesterday["qhd331skf"]).toFixed(2),
        qhd331shj:
        ...
        cfd64kf:
          today["cfd64kf"] == "" && yesterday["cfd64kf"] == ""
            ? ""
            : (today["cfd64kf"] - yesterday["cfd64kf"]).toFixed(2),
        cfd64hj:
        ...
        bz32kf:
          today["bz32kf"] == "" && yesterday["bz32kf"] == "" ? "" : (today["bz32kf"] - yesterday["bz32kf"]).toFixed(2),
        bz32hj:
