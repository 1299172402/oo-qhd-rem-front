    ...
    >
      ...
      >
        ...
        <el-table-column :label="`十四五规划外\n新摸排出潜力井位\n（2021-2025）`" align="center">
          <el-table-column prop="qljw" label="(口)" align="center" width="140"></el-table-column>
        </el-table-column>
        <el-table-column :label="`十四五规划外新摸排出潜力\n井位内外挂井槽可行性`" align="center">
          <el-table-column
            prop="knwgjcs"
            :label="`作业区论证\n可内外挂井槽数`"
            align="center"
