            ...
            <el-table-column prop="warningDesc" label="预警描述" min-width="250" align="center">
              <template slot-scope="scope">
                <el-tooltip class="item" effect="dark" :content="scope.row.warningDesc" placement="top">
                  ...
                  >
                    <span>{{ scope.row.warningDesc ? scope.row.warningDesc : "-" }}</span>
                  </div>
                </el-tooltip>
              </template>
            </el-table-column>
          ...
          <div class="g-row-flex-V" style="justify-content: space-between; margin-bottom: 10px">
            ...
            <div class="g-row-flex-V" style="flex-wrap: wrap; align-self: flex-end">
              <div style="margin: 10px 0px 10px 20px">
                <el-button v-show="canDownload" icon="el-icon-download" type="primary" @click="downloadFile1">
                  下载
                </el-button>
              </div>
            </div>
      ...
      <div v-if="radioValue == '区块指标预警' && switchNumber == '3'" style="height: 100%">
        <pagePanelNew style="margin-top: 0px; height: 100%" showBtn>
          <div class="g-row-flex-V" style="justify-content: space-between; margin-bottom: 10px">
            ...
            <div class="g-row-flex-V" style="flex-wrap: wrap; align-self: flex-end">
              <div style="margin: 10px 0px 10px 20px">
                <el-button v-show="canDownload" icon="el-icon-download" type="primary" @click="downloadFile2">
                  下载
                </el-button>
              </div>
            </div>
