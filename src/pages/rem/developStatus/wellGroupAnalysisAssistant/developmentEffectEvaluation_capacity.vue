    ...
    <div class="app-container">
        <header-search style="height:80px;">
            <div class="g-row-flex-V g-w100 g-h100">
                ...
                <el-button :style="{marginLeft:index==0?'auto!important':''}" v-for="(item, index) in dataList" :key="index" :class="item.isChecked?'el-button--primary': 'commonBtn'" @click="selectBtn(item)">{{ item.name }}</el-button>
            </div>
        </header-search>
        <el-main class="el-main">
            <div class="dom" style="margin-top: 20px; margin-bottom: 20px">
                <el-row :gutter="20" style="margin-top: -20px">
                    <el-col :span="12">
                        <pagePanel headerTitle="采油速度" style="width: 100%; height: 370px" :isShowMaxBtn="false">
                ...
                <el-row :gutter="20">
                    ...
                    <el-col :span="12">
                        <pagePanel headerTitle="注采比" style="width: 100%; height: 380px" :isShowMaxBtn="true">
                            <div class="infoZhu">
                                <span>合理注采比:</span>
                                <el-input-number v-model="lineStandOne" :controls="false" style="width: 180px" @change="setFirstLine"></el-input-number>
                                ...
                                <el-table :data="tableData" highlight height="230px" style="margin-top: 10px">
                                    ...
                                    <el-table-column label="理论值" align="center">
                                        <template slot-scope="scope">
                                            <el-input-number v-model="scope.row.theoryValue" :controls="false" style="width: 80px"></el-input-number>
                                        </template>
                                    </el-table-column>
    ...
    export default {
        ...
        data() {
            return {
                ...
                pageSize: 10,
                //油田列表
                oilFieldList: [{value: 'QHD32-6',label: '秦皇岛32-6油田'}],
                //区域列表
                areaList: [{value: '',label: '全部'},{value: '区块1',label: '区块1'}],
                //采油速度
                productionSpeed: {
                    tooltip: {
                        trigger: 'axis',
        ...
        methods: {
            ...
            getPageAuthMessage() {
                ...
                getWidgetByAreaUser({ areaCode: areaCode, loginName: loginName }).then((res) => {
                    ...
                    if (myList) {
                        let pageMes = myList.find((item) => {return item.resPvalue == myPath;});
                        if (pageMes) {
