        ...
        <pagePanel headerTitle="连通系数计算" style="height: 450px; width: 100%" class="g-w100">
          ...
          <el-form ref="form" label-width="100px" style="height: 100%;" :model="form">
                  ...
                  >
                      ...
                      <el-table-column prop="diviDingCoeff" label="连通系数?(动态调整)" min-width="120" align="center" :render-header="renderheader" show-overflow-tooltip class="lian">
                      ...
                      <el-table-column prop="injSplitData" label="劈分注水量?m³/d" :render-header="renderheader" show-overflow-tooltip min-width="125px" align="center"></el-table-column>
                      <el-table-column prop="operationalNarration" label="连通系数?(计算)" min-width="120" :render-header="renderheader" align="center"></el-table-column>
                      <el-table-column prop="operationInjSplitData" label="劈分注水量?m³/d" :render-header="renderheader" show-overflow-tooltip min-width="120px" align="center"></el-table-column>
                      <el-table-column prop="correctionFactor" label="连通系数?(修正)" min-width="120" :render-header="renderheader" align="center"></el-table-column>
                      <el-table-column prop="reviseInjSplitData" label="劈分注水量?m³/d" :render-header="renderheader" show-overflow-tooltip min-width="120px" align="center"></el-table-column>
