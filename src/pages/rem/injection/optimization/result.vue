...
<script>
  // import { getWellMonthAllocation, getWellMonthInj, getChatPlanINjAlloc, wellAvgFluidProdAllocUpdate } from "@/api/ipm-04/r-intelligentIPA.js";
      ...
      handleSubmit (form) {
        ...
        this.$refs[form].validate((valid) => {
          if (valid) {
            this.saveLoad = true
            this.modify = false
            wellAvgFluidProdAllocUpdate(this.form.tableData2).then((bool) => {
            }).finally(() => {
              this.saveLoad = false
            })
