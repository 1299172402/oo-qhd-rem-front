      ...
      <el-row :gutter="20" style="height: 100%">
            ...
            <div>
              <el-form ref="form" :rules="rules" style="height:calc(100% - 50px)" label-width="100px" :model="form">
                ...
                <!-- :span-method="arrheader" -->
                  ...
                  <el-table-column prop="layerNo" label="层位名称" align="center" width="220"></el-table-column>
                  <el-table-column
                    prop="oilWellNo"
                    show-overflow-tooltip
                    label="油井井号"
                  ...
                  >
                    <template slot-scope="scope">
                      ...
                      >
                        <el-input type="number" v-model="scope.row.groupInjRatio" @input="handleInput(scope.row)" />
                      </el-form-item>
                  ...
                  >
                    <template slot-scope="scope">
                      <span>{{ scope.row.injSplitData.toFixed(0)}}</span>
                    </template>
                  </el-table-column>
                </el-table>
                <el-table
                ...
                >
                <!-- :span-method="arrheader1" -->
                  <el-table-column prop="injWellNo" label="水井井号" align="center" min-width="160"></el-table-column>
        ...
        <el-col :span="8" style="height:100%">
          <pagePanel headerTitle="预测结果" style="height: calc(50% - 10px);margin-bottom: 20px;overflow-y: hidden" align="center">
            ...
            <el-table :data="tableData3" id="indexscv" highlight style="margin-top: 10px;max-height: 430px;overflow-y: auto;">
              <el-table-column prop="layerNo" label="层名" show-overflow-tooltip min-width="200" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    //查看方案
    viewDetail () {
      localStorage.setItem('OPTIMIZATION_DETAIL', JSON.stringify({...this.queryData, type:this.radio=='2'?1:0}))
    ...
    handleInput(row){
      this.form.tableData2.forEach(item =>{
        if(row.injWellId === item.injWellId){
