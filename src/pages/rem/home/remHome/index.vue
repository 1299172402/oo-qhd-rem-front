            ...
            currentLists: [
                [
                    ...
                    },
                    {
                        ...
                        boxText: '产量预测',
                        boxBottomText: ['递减率分析','产量变化趋势分析','采收率分析'],
                ...
                [
                    {
                        ...
                        boxText: '异常井监测',
                        boxBottomText: ['含水率变化监测', '递减率变化监测', '产液量异常监测','井底流压监测'],
                        boxStyle: {
                            pWidth: 'width:11vw',
                        },
                    ...
                    },
                    {
                        ...
                        boxText: '单井/井组/区块分析',
                        boxBottomText: ['水质分析','注采比分析','来水方向分析','储量动用情况'],
