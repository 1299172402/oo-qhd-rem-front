...
<!--        &lt;!&ndash; 在这里放置image标签作为背景图 &ndash;&gt;-->
<!--        <image xlink:href="@/pages/rem/home/reservoirDisplay/modules/油藏看板视频底色.svg" width="100%" height="100%" />-->

        <!-- 在这里放置img标签 -->
        <foreignObject width="100%" height="100%">
            <img id="im" style="width: 100%; height: 100%;" />
        </foreignObject>
    </svg>
</template>
