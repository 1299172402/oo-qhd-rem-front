    ...
    data() {
        return {
            ...
            layout: [
                ...
                { x: 8, y: 8, w: 4, h: 8, i: "2", name: "油田大事件", show: true },
                { x: 0, y: 16, w: 8, h: 12, i: "3", name: "秦皇岛32-6油田月度产量对比图", show: true },
                { x: 8, y: 16, w: 4, h: 12, i: "4", name: "产量构成详情", show: true },
                { x: 0, y: 28, w: 4, h: 12, i: "5", name: "产能波动", show: true },
                { x: 4, y: 28, w: 4, h: 12, i: "6", name: "问题井统计", show: true },
                { x: 8, y: 28, w: 4, h: 12, i: "7", name: "关停井统计", show: true },
                { x: 0, y: 40, w: 4, h: 20, i: "8", name: "单井井底流压", show: true },
                { x: 4, y: 40, w: 4, h: 20, i: "9", name: "分层注入量", show: true },
                { x: 8, y: 40, w: 4, h: 10, i: "10", name: "措施效果跟踪表", show: true },
                { x: 8, y: 50, w: 4, h: 10, i: "11", name: "超欠注情况统计", show: true },
                { x: 0, y: 70, w: 4, h: 12, i: "12", name: "自然递减率", show: true },
                { x: 4, y: 70, w: 4, h: 12, i: "13", name: "采油速度", show: true },
                { x: 0, y: 80, w: 4, h: 12, i: "14", name: "采出程度与含水率关系图", show: true },
                { x: 4, y: 80, w: 4, h: 12, i: "15", name: "含水上升", show: true },
                { x: 8, y: 70, w: 4, h: 24, i: "16", name: "秦皇岛32-6油田生产指标总览", show: true },
            ]
        };
    },
    methods: {
