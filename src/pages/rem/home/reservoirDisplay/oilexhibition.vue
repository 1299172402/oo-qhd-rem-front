    ...
    data() {
        return {
            ...
            layout: [
                ...
                { x: 0, y: 70, w: 3, h: 12, i: "12", name: "自然递减率", show: true },
                { x: 3, y: 70, w: 3, h: 12, i: "13", name: "采油速度", show: true },
                { x: 0, y: 80, w: 3, h: 12, i: "14", name: "采出程度与含水率关系图", show: true },
                { x: 3, y: 80, w: 3, h: 12, i: "15", name: "含水上升", show: true },
                { x: 6, y: 70, w: 4, h: 24, i: "16", name: "秦皇岛32-6油田生产指标总览", show: true },
            ]
        };
    },
    methods: {
