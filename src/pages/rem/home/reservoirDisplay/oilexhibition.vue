    ...
    data() {
        return {
            ...
            layout: [
                ...
                { x: 0, y: 16, w: 8, h: 13, i: "3", name: "秦皇岛32-6油田月度产量对比图", show: true },
                { x: 8, y: 16, w: 4, h: 26, i: "4", name: "秦皇岛32-6油田生产指标总览", show: true },
                { x: 0, y: 28, w: 4, h: 13, i: "5", name: "产能波动", show: true },
                { x: 4, y: 28, w: 4, h: 13, i: "6", name: "问题井统计", show: true },
