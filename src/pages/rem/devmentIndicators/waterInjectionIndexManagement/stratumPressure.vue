    ...
    <page-panel-new class="app-content">
      ...
      <pagePanel headerTitle="原始地层压力保持水平 (层位)" style="height: 550px" show-btn>
        <div style="display: flex; justify-content: flex-end">
          <el-button
            ...
            type="primary"
            @click="doDownExcel('#ysdcylbcsp', '原始地层压力保持水平 (层位)')"
            >下载</el-button
          >
        </div>
        <el-table id="ysdcylbcsp" :data="tableData1" highlight height="calc(100% - 55px)">
          ...
          <el-table-column label="原始参数" align="center">
            <el-table-column
              prop="originalLayerPressureYear"
              :label="`原始地层压力\n(MPa)\n(校正到基准面)`"
              align="center"
          ...
          <el-table-column label="2023年" align="center">
            <el-table-column
              prop="originalReservesOil"
              :label="`动用地质储量\n(10⁴m³)`"
              align="center"
              :formatter="toPrecise4"
            ></el-table-column>
            <el-table-column
              prop="layerPressureYear"
              :label="`地层压力\n(MPa)`"
              align="center"
              :formatter="toPrecise2"
            ></el-table-column>
            <el-table-column
              prop="layerPressureLevelYear"
              :label="`原始地层压力保持水平\n(%)`"
              align="center"
              width="200"
              :formatter="toPrecise2"
      ...
      <div style="padding-bottom: 20px">
        <pagePanel headerTitle="单井静压明细" style="height: 550px" show-btn>
          <div style="display: flex; justify-content: flex-end">
            <el-button style="margin-bottom: 20px" type="primary" @click="doDownExcel('#djjymx', '单井静压明细')"
              >下载</el-button
            >
          </div>
          <el-table id="djjymx" :data="tableData2" highlight height="calc(100% - 55px)">
            ...
            ></el-table-column>
            <el-table-column
              prop="midOillayerStaticPress"
              :label="`油层中部压力\n(MPa)`"
              align="center"
              :formatter="toPrecise2"
            ></el-table-column>
            <el-table-column
              prop="measurePointPress"
              :label="`最大垂深测点压力\n(10⁴m³)`"
              align="center"
              :formatter="toPrecise4"
            ></el-table-column>
