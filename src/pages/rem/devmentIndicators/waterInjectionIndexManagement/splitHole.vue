...
<template>
    <div class="app-container">
        ...
        <page-panel-new class="app-content">
            <pagePanel headerTitle="分注井层段合格率*" style="height: 490px" showBtn>
                ...
                <Echart :chart-data="sectionPassRate" height="calc(100% - 65px)"></Echart>
            </pagePanel>
            <el-row :gutter="20" style="padding-bottom:20px;">
                <el-col :span="12">
                    <pagePanel :headerTitle="`${oilFieldName || ''}分注井层段合格率明细*`" style="height: 490px" showBtn>
                        <el-button style="position: absolute; z-index: 9; right: 56px; top: 0; height: 26px; margin-top: 3px;line-height: 8px;" type="primary" @click="doDownExcel('#fzjcdhglmx', `${oilFieldName || ''}分注井层段合格率明细`)">
                            下载
                        </el-button>
                        <div class="g-row-flex-V" style="margin-bottom: 20px">
                            <div style="margin-right: 20px">
                        ...
                        <el-table id="fzjcdhglmx" :data="tableData1" highlight height="calc(100% - 65px)">
                            <!-- :index="formatIndex"  -->
                ...
                <el-col :span="12">
                    <pagePanel :headerTitle="`${oilFieldName || ''}单井层段合格明细*`" style="height: 490px" showBtn>
                        <el-button style="position: absolute; z-index: 9; right: 56px; top: 0; height: 26px; margin-top: 3px;line-height: 8px;" type="primary" @click="doDownExcel('#djcdhgmx', `${oilFieldName || ''}单井层段合格明细`)">
                            下载
                        </el-button>
                        <div class="g-row-flex-V" style="margin-bottom: 20px">
                            <div style="margin-right: 20px">
                        ...
                        <el-table id="djcdhgmx" :data="tableData2" highlight height="calc(100% - 65px)">
                            <!-- :index="formatIndex"  -->
                            <el-table-column label="序号" header-align="center" align="center" type="index" width="60"></el-table-column>
