...
<template>
    <div class="tab-container">
        <info-window infoWidth="100%" :infoHeight="height+'px'" :headerTitle="searchForm.oilFieldName + '年度计划运行曲线'" isShowMaxBtn style="margin-top:0;">
            ...
            <Echart :chart-data="OilYearLineChart" height="100%"></Echart>
        </info-window>
        <info-window infoWidth="100%" infoHeight="500px" :headerTitle="searchForm.oilFieldName + '年度计划运行'" isShowMaxBtn style="margin-top: 10px">
            <div slot-name="titleContent">
