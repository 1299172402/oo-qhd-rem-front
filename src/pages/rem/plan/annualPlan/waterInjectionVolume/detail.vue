    ...
    <div class="z-main">
      <pagePanel
        :headerTitle="
          ...
          'm³'
        "
        style="height: calc(50% - 10px); margin-top: 0"
        show-btn
      >
        ...
        toolbox: {
          ...
          feature: {
            saveAsImage: {
              name:
                "老井转注 井次：" +
                (this.oldWellCount ? this.oldWellCount : 0) +
                "口 注入量：" +
                (this.oldInjectionCount ? this.oldInjectionCount : 0) +
                "m³",
        ...
        toolbox: {
          ...
          feature: {
            saveAsImage: {
              name:
                "新井投注 新井：" +
                (this.newWellCount ? this.newWellCount : 0) +
                "口 注入量：" +
                (this.newInjectionCount ? this.newInjectionCount : 0) +
                "m³",
              pixelRatio: 15, //值越大分辨率越高,下载的图片越清晰
              backgroundColor: "#022644",
              iconStyle: {
