<template>
    <info-window infoWidth="100%" infoHeight="100%" headerTitle="附表18 秦皇岛32-6/渤中作业公司示范油田概况" :isShowMaxBtn="true">
        <el-table id="tableData" class="doubleHeader" :row-style="{ height: '0px' }" :header-cell-style="{ 'text-align': 'center', padding: '0px 0' }" :data="tableData" header-cell-class-name="table_header"
            ...
            <el-table-column prop="oilField" label="示范油田" align="center" width="120" fixed></el-table-column>
            <el-table-column prop="kfjd" :label="`开发阶段\n（在生产、在建设、\n开发评价）`" align="center" width="160"></el-table-column>
            ...
            <el-table-column label="示范工程简况" align="center">
                <el-table-column prop="sfnr" :label="`重点示范内容\n（综合调整、二次加密、稠油热采、低渗压裂、\n注气开发等`" align="center" width="340"></el-table-column>
