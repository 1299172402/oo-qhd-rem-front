<template>
    <pagePanel infoWidth="100%" infoHeight="100%" headerTitle="附表17 秦皇岛32-6作业公司控制递减综合治理专项工作" style="height: 100%;" showBtn>
        <el-table id="tableData" class="doubleHeader" :row-style="{ height: '0px' }" :header-cell-style="{ 'text-align': 'center', padding: '0px 0' }" :data="tableData" header-cell-class-name="table_header"
            ...
            <el-table-column prop="yxjj" label="优先解决的问题" align="center" min-width="340"></el-table-column>
            <el-table-column prop="jjtj" label="主要解决途径" align="center" min-width="460"></el-table-column>
            <el-table-column prop="jdmb" :label="`阶段目标\n（油水井数比、阶段注采比、压力保持水平、\n含水上升率、自然递减率）`" align="center" min-width="340"></el-table-column>
            <el-table-column prop="zxgz" :label="`控制递减综合治理专项工作\n（1~2年期）`" align="center" min-width="400"></el-table-column>
        </el-table>
    </pagePanel>
</template>
