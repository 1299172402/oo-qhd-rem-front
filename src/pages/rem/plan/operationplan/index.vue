    ...
    <div class="app-container">
        <pagePanelNew headerTitle="现场作业计划表" style="height: calc(100% - 100px)">
            ...
            >
                ...
                <el-table-column label="当前作业内容" prop="CurrentJobContent" align="center">
                </el-table-column>
                <el-table-column label="作业井号" prop="JobWellNo" align="center">
                </el-table-column>
...
import {getWorkCompany,getOilFieldList} from "../../../../api/rem/workcompanydesignate";
export default {
    name: 'Notice',
    ...
    methods: {
        ...
        getList() {
            ...
            getOnSiteWork(this.queryParams)
                .then((res) => {
