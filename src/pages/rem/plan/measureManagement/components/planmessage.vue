        ...
        <pagePanel headerTitle="措施计划情况表" style="height: calc(100% - 20px)">
            ...
            >
                ...
                <el-table-column label="其他因素" prop="name" align="center">
                    ...
                    <el-table-column sortable min-width="130px" :label="`近期出砂(d)`" prop="sandDay" align="center" v-if="$route.query.measureCode != '0100102' &&  $route.query.measureCode != '0100106' && $route.query.measureCode != '0100111' && $route.query.measureCode != '0100111' ">
                        <template slot-scope="scope">
                            <span
                    ...
                    <el-table-column sortable min-width="150px" :label="`最大出砂量(%)`" prop="sandValue" align="center" v-if="$route.query.measureCode != '0100102'&& $route.query.measureCode != '0100111' && $route.query.measureCode != '0100106' && $route.query.measureCode != '0100111'">
                        <template slot-scope="scope">
                            <span
                    ...
                    <el-table-column sortable min-width="150px" :label="`防砂措施`" prop="sandMeasure" align="center" v-if="$route.query.measureCode != '0100102' && $route.query.measureCode != '0100106'&& $route.query.measureCode != '0100111'  && $route.query.measureCode != '0100111'">
                        <template slot-scope="scope">
                            <span
                    ...
                    <el-table-column sortable min-width="150px" :label="`措施时间\n(yyyy-mm-dd)`" prop="measureTime" align="center" v-if="$route.query.measureCode != '0100102'&& $route.query.measureCode != '0100111'  && $route.query.measureCode != '0100106' && $route.query.measureCode != '0100111'">
                        <template slot-scope="scope">
                            <span
