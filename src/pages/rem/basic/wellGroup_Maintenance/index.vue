            ...
            <header-search class="g-w100 g-h100" style="height: auto">
                <el-form :inline="true" label-width="40px">
                    ...
                    <el-form-item label="区块:">
                        <el-select v-model="query.selectBlock" style="margin-left: 20px" placeholder="请选择" class="f2"
                                   ref="elselect1">
                            <el-option
                    ...
                    <el-button style="margin-left: 20px" type="primary" size="mini" icon="el-icon-search"
                    ...
                    <el-button type="primary" v-if="this.$route.query.link == 'linkage'" style="float: right"
                               @click="goBack"> 返回
                    </el-button>
                </el-form>
...
<!--                        </el-button>-->
        ...
        <el-dialog title="井组自定义" :visible.sync="dialogVisible" class="dalog" width="50%">
            <el-form inline label-width="70px">
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="时间">{{ query.value2 }}</el-form-item>
                    </el-col>
                    <el-col :span="12">
                    ...
                    <el-col :span="12">
                        <el-form-item label="水井">
                            <el-select v-model="select.waterBlock" placeholder="请选择" class="f2" @change="waterBut"
                                       filterable>
                                <el-option
            ...
            <span slot="footer" style="align:center " class="dialog-footer">
