<template>
    <div class="app-container">
        ...
        <page-panel-new :show-btn="true" v-if="!activeEchart" style="min-height: calc(100% - 90px);height: auto">
            <el-row>
                    ...
                    <page-panel :show-btn="true" headerTitle="状态指标" style="min-height: 250px"
                        ...
                        <el-row :gutter="10">
                            <el-checkbox-group v-model="stateValue">
                                <el-col v-for="item in stateList" :key="item.id" :span="6" style="min-width: 120px">
                    ...
                    >
                        <el-row :gutter="10">
                            <el-checkbox-group v-model="productValue">
                                <el-col v-for="item in productList" :key="item.val" :span="8" style="min-width: 120px">
                                    <el-checkbox :label="item.val" :value="item.val">
                                        {{ item.name ? item.name : item }}
                                    </el-checkbox>
                                </el-col>
                    ...
                    <page-panel :show-btn="true" headerTitle="累产指标" style="min-height: 250px"
                        ...
                        <el-row :gutter="10">
                            <el-checkbox-group v-model="totalValue">
                                <el-col v-for="item in totalList" :key="item.val" :span="6" style="min-width: 120px">
                                    <el-checkbox :label="item.val" :value="item.val">
                                        {{ item.name ? item.name : item }}
                                    </el-checkbox>
                                </el-col>
                    ...
                    <page-panel :show-btn="true" headerTitle="注入指标" style="min-height: 250px"
                        ...
                        <el-row :gutter="10">
                            <el-checkbox-group v-model="injectValue">
                                <el-col v-for="item in injectList" :key="item.val" :span="6" style="min-width: 120px">
                                    <el-checkbox :label="item.val" :value="item.val">
                                        {{ item.name ? item.name : item }}
                                    </el-checkbox>
                                </el-col>
                    ...
                    >
                        <el-row :gutter="10">
                            <el-checkbox-group v-model="managerValue">
                                <el-col v-for="item in managerList" :key="item.val" :span="6" style="min-width: 120px">
                                    <el-checkbox :label="item.val" :value="item.val">
                                        {{ item.name ? item.name : item }}
                                    </el-checkbox>
                                </el-col>
                    ...
                    <page-panel :show-btn="true" headerTitle="储采指标" style="min-height: 250px"
                        ...
                        <el-row :gutter="10">
                            <el-checkbox-group v-model="storeValue">
                                <el-col v-for="item in storeList" :key="item.val" :span="6" style="min-width: 120px">
                                    <el-checkbox :label="item.val" :value="item.val">
                                        {{ item.name ? item.name : item }}
                                    </el-checkbox>
                                </el-col>
