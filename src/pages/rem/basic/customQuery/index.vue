<template>
    <div class="app-container">
        ...
        <page-panel-new v-else-if="activeEchart" style="height:100%">
    ...
    methods: {
        ...
        doSearch(val) {
            if(this.activeEchart){
                ...
                this.tableData = []
                let newArr = this.stateValue.concat(this.productValue,this.totalValue,this.injectValue,this.managerValue)
                let tableArr = []
