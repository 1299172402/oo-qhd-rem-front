...
<template>
    <div class="app-container">
        <pagePanelNew class="pagePanelNew" style="margin-top:0;">
            ...
            <el-tabs class="g-pageHeader" v-model="selectType" topline @change="tabsChange">
            ...
            <div class='container'>
                <div class="search" v-if="selectType!='通用配置'">
                    ...
                    <el-button type="primary" style="margin-left:15px!important;" @click="addTableRow">新增</el-button>
                </div>
                ...
                <div class="childComponents" :style="{height:selectType=='通用配置'? '100%' : 'calc(100% - 50px)' }" v-if='modeSelectList.length'>
                    ...
                    <tableComponents2 :selectType="selectType" :searchForm="searchForm" :modeSelectList="modeSelectList"  v-if="selectType=='按区块配置'" style="height:300px;"></tableComponents2>
                    <tableComponents3 :selectType="selectType" :searchForm="searchForm" :modeSelectList="modeSelectList"  v-if="selectType=='按井型配置'" style="height:300px;"></tableComponents3>
                    <tableComponents4 :selectType="selectType" :searchForm="searchForm" :modeSelectList="modeSelectList"  v-if="selectType=='按井配置'" style="height:300px;"></tableComponents4>
                </div>
            </div>
        </pagePanelNew>
    </div>
