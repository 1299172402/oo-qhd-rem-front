<template>
  <div class="app-container">
    <headerSearch class="g-w100 g-h100">
      <div style="padding-top:12px;display: flex;align-items: center;">
        ...
        <el-select
          ...
          @change="doChangePT"
        >
          <el-option v-for="item in platform" :key="item.platFormId" :label="item.platName" :value="item.platFormId">
          </el-option>
        </el-select>
        ...
        <el-upload ref="upload"  style="margin-left: 20px;" class="upload-demo" action="" :on-preview="handlePreview" :on-remove="handleRemove" :before-remove="beforeRemove"
          :auto-upload="false" :on-change="useUploadPic" :on-exceed="handleExceed" :file-list="fileList" :show-file-list="false" :on-success="handleSuccess" v-show="canUpload && !ljpmTag">
    ...
    <el-main>
      <el-tabs v-model="activeName" topline @tab-click="handleClick">
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        aaa:'smallLayerStructureDiagram',
        //选择油田
        selectOilField: '',
        //油田列表
        oilField: [],
        ...
        tabsPathName: [
          ...
          { name: 'fluidProducingProfile', pathName: 'PRODUCTION_PROFILE_RESULTS' }, //产液剖面
        ...
        ljpmFileList: [],
        wellList: [
          { prodPlatformName: '1', key: '1', label: '1' },
          { prodPlatformName: '2', key: '2', label: '2' },
          { prodPlatformName: '1', key: '3', label: '3' },
          { prodPlatformName: '2', key: '4', label: '4' },
          { prodPlatformName: '1', key: '5', label: '5' },
          { prodPlatformName: '2', key: '6', label: '6' },
          { prodPlatformName: '1', key: '7', label: '7' },
          { prodPlatformName: '2', key: '8', label: '8' },
          { prodPlatformName: '1', key: '9', label: '9' },
          { prodPlatformName: '2', key: '10', label: '10' },
          { prodPlatformName: '1', key: '11', label: '11' },
          { prodPlatformName: '2', key: '12', label: '12' },
          { prodPlatformName: '1', key: '13', label: '13' },
          { prodPlatformName: '2', key: '14', label: '14' },
          { prodPlatformName: '1', key: '15', label: '15' },
          { prodPlatformName: '2', key: '16', label: '16' },
        ],
