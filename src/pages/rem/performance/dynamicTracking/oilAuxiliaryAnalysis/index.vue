        ...
        <headerSearch style="height:80px;">
            <div class="g-row-flex-V g-w100 g-h100">
                ...
                <el-upload ref="upload" style="margin-left: 20px" class="upload-demo" action=""
                    ...
                    v-show="canUpload && !ljpmTag &&(currentModule=='wellNetworkDiagram' || currentModule=='completionStringDrawing' || currentModule=='fluidProducingProfile' || currentModule=='saturationLog' ||currentModule =='wellTestReport')">
