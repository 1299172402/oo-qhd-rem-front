    ...
    >
      <headerSearch style="height: 80px">
        <div class="g-row-flex-V g-w100 g-h100">
          ...
          <el-button class="commonBtn" icon="el-icon-refresh" style="margin-right: auto" @click="resetting"
            >重置</el-button
          >
        </div>
      </headerSearch>

      <pagePanelNew headerTitle="油井辅助分析" style="height: calc(100% - 100px)" class="g-w100">
        <div
...
export default {
  ...
  methods: {
    ...
    //查询油井信息@param oilFieldId
    getFetchProductionWells(isOilFieldId) {
      QueryWellDetail({
        ogfId: this.selectOilField,
