    ...
    <headerSearch style="height: 80px">
      <div class="g-row-flex-V g-w100 g-h100">
        ...
        <!-- <span class="title">层系：</span>
          ...
          <span v-if="newinfo" class="title">井组：</span>
          <el-select v-if="newinfo" v-model="selectWellGroup" placeholder="请选择" filterable clearable style="margin-right: 20px">
            <el-option
  ...
  watch: {
    ...
    newinfo: {
      ...
      handler(val) {
        ...
        let requestWellGroup = { ...this.selectOilField };
        if (val == true) {
          ...
          wellGroupList(requestWellGroup).then((res) => {
            if (res.data.code == 200) {
              this.wellGroup = res.data.data;
              this.selectWellGroup = this.wellGroup[0].wellGroupId;
            }
          });
        }
