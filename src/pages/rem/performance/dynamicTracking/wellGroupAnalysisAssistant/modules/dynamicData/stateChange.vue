    ...
    <el-table  highlight :data="tableData" height="calc(100% - 101px)" style="margin-top:-30px">
      ...
      <el-table-column prop="fieldName" label="总井数" header-align="center"></el-table-column>
       <el-table-column prop="fieldName" label="油井数" header-align="center"></el-table-column>
          <el-table-column prop="fieldName" label="水井数" header-align="center"></el-table-column>
      <el-table-column header-align="center">
        <template slot="header">
          <div>受控井</div>
        </template>
        <el-table-column label="单向" header-align="center"> </el-table-column>
        <el-table-column label="双向" header-align="center"> </el-table-column>
        <el-table-column label="多向" header-align="center"> </el-table-column>
        <el-table-column label="小计" header-align="center"> </el-table-column>
        <el-table-column label="受控率(%)" header-align="center"> </el-table-column>
      </el-table-column>
      <el-table-column prop="fieldName" label="非受控井" header-align="center"></el-table-column>
    </el-table>
  </el-form>
</template>
