...
<template>
    <el-table 
      ...
      <el-table-column prop="wellName" label="井标识" width="180" min-width="160"></el-table-column>
      <el-table-column prop="measureDepth" label="测点斜深 (m)"></el-table-column>
      <el-table-column prop="measureVerticalDepth" label="测点垂深 (m)"></el-table-column>
      <el-table-column prop="deviationAngle" label="井斜角 (°)"></el-table-column>
      <el-table-column prop="azinuthAngle" label="方位角 (°)"></el-table-column>
