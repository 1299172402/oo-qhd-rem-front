      ...
      <div>
        ...
        <el-row style="padding-top: 20px">
          <div style="height: 600px">
              <pagePanel headerTitle="示踪剂解释成果"
                style="width: 49.5%; height: 600px;overflow: auto;position: absolute;left: 0;top: 0"
            >
              ...
              <pagePanel headerTitle="示踪剂报告"
                style="width: 49.5%; height: 600px;position: absolute;right: 0;top: 0"
            >
              <iframe :src="imageSecond?(imageSecond+'#toolbar=0'):''" style="width: 100%;height: 100%;"></iframe>
              </pagePanel>
          </div>
<!--            <pagePanel style="margin-top: 10px;height:600px;overflow: auto;">-->
    ...
    doSearch(val) {
      let request = {
        ...
        // wellGroupId: this.wellGroupId,
          oilFieldId: val.ogfId,
          fieldId: this.blockId,
          fieldLayerId: this.layerId,
          wellGroupId: val.selectWellId,
      };
