    ...
    data () {
        return {
            ...
            operationTypeList:{
                ...
                reservoirProfile:{//地震剖面图
                    operationType:'BLOCKDZPMT',
                    limit:1,
                    fileType:['bmp','jpg','jpeg','png','pdf']
                },
                effectiveThicknessMap:{//有效厚度图
                    operationType:'BLOCKYXHDT',
                    limit:1,
                    fileType:['bmp','jpg','jpeg','png','pdf']
                },
                permeabilityCurve:{//相渗透率曲线
                ...
                developmentPlan:{//开发方案
                    operationType:'BLOCKJZLTT',
                    limit:1,
                    fileType:['pdf']
                },
                developmentAdjustmentPlan:{//开发调整方案
