    ...
    export default {
        ...
        data() {
            return {
                ...
                tabsPathName: [
                    ...
                    /*{name: 'yieldCompositionCurve', pathName: 'YIELD_COMPONENTS'},//产量构成曲线*/
                    {
                        name: 'reservesReport',
            ...
            currentModule: {
                ...
                handler(newName, oldName) {
                    this.loader().then(() => {
                        ...
                        console.log('走catch');
                        // this.component = () => import("./modules/reservoirData/structuralMap.vue");
                    });
                }
            },
        },
        ...
        methods: {
            ...
            async useUploadPic(file, fileList) {
                ...
                // }
                if (tabName.pathName == 'STRUCTURE' || tabName.pathName == 'COMPREHENSIVE_GEOLOGY' || tabName
                    .pathName == 'DEPOSITION' || tabName.pathName == 'THICKNESS_SAND_LAYER' || tabName.pathName ==
                    'EFFECTIVE_THICKNESS' ||
                    tabName.pathName == 'PHASE_PERMEABILITY' || tabName.pathName == 'POROSITY_FRACTURE' || tabName
                    .pathName == 'CUMULATIVE_OIL_WATER' || tabName.pathName == 'SURPLUS_OIL' || tabName.pathName ==
                    'LIQUID_OIL_WATER_EQUIVALENCE' ||
                    tabName.pathName == 'LIQUID_OIL_WATER_DIFFERENCE' || tabName.pathName ==
                    'TOTAL_PRESSURE_DROP' || tabName.pathName == 'DIFFERENTIAL_PRESSURE' || tabName.pathName ==
                    'FLUID_STRENGTH_EQUIVALENCE' || tabName.pathName == 'INJECTION_INTENSITY_EQUIVALENCE' ||
                    tabName.pathName == 'INJECTION_PRODUCTION_SCORE_LAYOUT' || tabName.pathName ==
            ...
            isCorrectFileType(type) {
                if (
                this.currentModule == 'structuralMap' || this.currentModule == 'geologicalMap' || this.currentModule == 'sedimentaryMicrofacies' 
                || this.currentModule == 'reservoirProfile' || this.currentModule == 'sandThicknessMap' || this.currentModule == 'effectiveThicknessMap' 
                || this.currentModule == 'permeabilityCurve' || this.currentModule == 'porosityDevelopment' || this.currentModule == 'wellPattern' 
                || this.currentModule == 'wellPatternImprovementChart' ||this.currentModule == 'cumulativeOilWaterProduction' || this.currentModule == 'remainingOil' 
                || this.currentModule == 'oilwaterIsoline' || this.currentModule == 'liquidOilDifferenceDiagram' || this.currentModule == 'totalPressureDropDiagram' 
                || this.currentModule == 'differentialPressureDiagram' || this.currentModule =='fluidStrengthEquivalence' || this.currentModule == 'isogramOfWaterInjectionIntensity' 
                || this.currentModule == 'cumulativeOilProductionPerMeter' || this.currentModule =='distributionOfAccumulatedwateroilRatio' 
                || this.currentModule == 'injectionProductionRatioDistribution' || this.currentModule =='permeabilityDistribution') {
                ...
                } else if (this.currentModule == 'reservesReport' || this.currentModule == 'developmentPlan' || this.currentModule == 'developmentAdjustmentPlan') {
