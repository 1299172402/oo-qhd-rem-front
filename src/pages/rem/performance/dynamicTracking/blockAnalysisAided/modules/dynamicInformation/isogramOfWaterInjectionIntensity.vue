...
<template>
  <div class="mt-2">
    <el-row style="margin-top:10px">
      ...
      <el-button @click="OnChangeImage">确认</el-button>
    </el-row>
    <el-row style="margin-top:10px">
...
import {dynamicDataContourMapOfInjectionIntensity} from "@/api/oilDeposit/rem-01/fielddynamicanalysis.js";
...
return item.fieldLayerId == '263518079CED49AE8B6C9FE5CEBDD26A'
       ...
       * 获取图片组信息
       */
      await dynamicDataContourMapOfInjectionIntensity(request).then((res)=>{
        if(res.data.code==0){
