...
<template>
    <page-panel-new style="height:calc(100% - 101px);margin-top:0;" show-btn>
        <el-table 
            ...
            <el-table-column :label="`含油气高度\n (m)`" align="center" prop="oilGasColumnHeight" width="140"></el-table-column>
            <el-table-column :label="`油气藏中部海拔\n (m)`" width="140" align="center" prop="reservoirMidElevation"></el-table-column>
            ...
            <el-table-column :label="`原始饱和压力\n (MPa)`" width="140" align="center" prop="originSaturationPress"></el-table-column>
            <el-table-column :label="`地饱压差\n (MPa)`" width="140" align="center" prop="reservoirsPressure"></el-table-column>
            ...
            <el-table-column :label="`饱和压力\n (MPa)`" width="140" align="center" prop="saturationPressure"></el-table-column>
            <el-table-column :label="`饱和压力下原油粘度\n (mPa·s)`" width="160" align="center" prop="oilViscosityAt"></el-table-column>
            <el-table-column :label="`饱和压力下原油密度\n (g/cm³)`" width="160" align="center" prop="oilViscosity"></el-table-column>
            <el-table-column :label="`脱气原油密度\n (g/cm³)`" width="140" align="center" prop="deadOilDensity"></el-table-column>
            <!--<el-table-column label="热膨胀" align="center" prop=""></el-table-column>-->
            <el-table-column :label="`死油密度\n (g/cm³)`" width="140" align="center" prop="degassedOilDensity"></el-table-column>
