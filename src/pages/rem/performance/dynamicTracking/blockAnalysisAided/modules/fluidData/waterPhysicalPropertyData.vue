...
<template>
  <page-panel-new style="height: calc(100% - 101px); margin-top: 0" show-btn>
    ...
    >
      ...
      <el-table-column prop="fluidPH" label="PH值/酸碱度" align="center" min-width="140"> </el-table-column>
      <el-table-column prop="color" label="颜色" align="center" min-width="140"> </el-table-column>
      <el-table-column prop="" :label="`地层水矿化度\n (mg/L)`" align="center" min-width="140"> </el-table-column>
      ...
      <el-table-column prop="resis" :label="`电阻率\n (Ωm)`" align="center" min-width="140"> </el-table-column>
    </el-table>
  </page-panel-new>
</template>
