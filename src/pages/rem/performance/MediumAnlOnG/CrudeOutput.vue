  ...
  <el-container class="layout">
    ...
    <el-main>
      ...
      <el-row :gutter="20" style="margin-top: 10px">
        <el-col :span="12">
          <info-window info-width="100%" info-height="100%" header-title="基础产量" :is-show-max-btn="true">
            <Echart :chart-data="OldLineChart" height="300px"></Echart>
          </info-window>
        </el-col>
        <el-col :span="12">
          <info-window info-width="100%" info-height="100%" header-title="措施产量" :is-show-max-btn="true">
            <Echart :chart-data="productLineChart" height="300px"></Echart>
          </info-window>
        </el-col>
      </el-row>
      <el-row :gutter="20" style="margin-top: 10px">
        <el-col :span="12">
          <info-window info-width="100%" info-height="100%" header-title="调整井产量" :is-show-max-btn="true">
            <Echart :chart-data="resetProLineChart" height="300px"></Echart>
          </info-window>
        </el-col>

        <el-col :span="12">
          <info-window info-width="100%" info-height="100%" header-title="上年老井本年产量" :is-show-max-btn="true">
            <Echart :chart-data="lastYearProLineChart" height="300px"></Echart>
          </info-window>
        </el-col>
      </el-row>
      <el-row :gutter="20" style="margin-top: 10px">
        <el-col :span="12">
          <info-window info-width="100%" info-height="100%" header-title="上年投产新井产量" :is-show-max-btn="true">
            <Echart :chart-data="lastYearUseLineChart" height="300px"></Echart>
          </info-window>
        </el-col>
        <el-col :span="12">
          <info-window info-width="100%" info-height="100%" header-title="开发井产量" :is-show-max-btn="true">
            <Echart :chart-data="devWellLineChart" height="300px"></Echart>
          </info-window>
        </el-col>
      </el-row>
    </el-main>
