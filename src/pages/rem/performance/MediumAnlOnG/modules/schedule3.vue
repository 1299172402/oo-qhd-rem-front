<template>
  <el-container class="layout">
    <info-window
      info-width="100%"
      info-height="100%"
      header-title="附表3 秦皇岛32-6/渤中作业公司历年自然递减率"
    ...
    >
      ...
      >
        ...
        ></el-table-column>
        <el-table-column prop="oilField" label="油田" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column prop="2016" label="2016年" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column prop="2017" label="2017年" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column prop="2018" label="2018年" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column prop="2019" label="2019年" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column prop="2020" label="2020年" align="center" show-overflow-tooltip></el-table-column>
      </el-table>
    </info-window>
  </el-container>
</template>
