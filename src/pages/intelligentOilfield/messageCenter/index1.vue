      ...
      <div>
        ...
        <div style="margin-top: 20px">
          ...
          <div class="g-row-flex-V">
            ...
            <div class="g-row-flex-V" style="margin: 0 10px">
              ...
              <div>
                <el-select style="width: 150px" v-model="statusModel" placeholder="请选择设备状态" @change="changeStatusSource"
                  clearable>
        ...
        <div class="g-row-flex-V" style="flex-wrap: wrap; margin-top: 10px">
          <div class="typeClass" v-for="(item, index) in searchList" :key="index">
            <div class="bgClass g-row-flex-V g-w100 g-h100" style="width: 170px; cursor: pointer"
    ...
    <div style="height: 728.8px;position:relative;" :style="{marginTop: isFullScreen ? '25px': '5px'}" class="g-row-flex">
            ...
            <div class="g-row-flex-V"
              ...
              <div class="g-column-flex-V" style="height: calc(100% - 30px);position:relative;">
                <div class="typeClass g-row-flex-V" v-for="(item, index) in resultIptList" :key="index" style="">
                  <div class="bgClass g-row-flex-V g-w100 g-h100" style="cursor: pointer"
                    :style="{ background: $store.state.setting.mode === 'dark' ? 'rgba(0,169,159,0.3)' : 'rgba(0,169,159,0.5)' }"
                    @click="clickItem(item, '工作项')">
                    <div class="circleStyle" :style="{ background: item.isGreen ? '#309800' : '#FF4D4F' }"></div>
                  ...
                  <lineSvg style="top:5px"
                    :setPoints="index === 0 ? topLine : index === 1 ? '0,20 180,20 180,19 180,30 258,30' : index === 2 ? '0,20 180,20 180,19 180,5 258,5' : ''">
                  </lineSvg>
                  <lineSvg style="top:-27px" v-if="index === 3" :setPoints="bottomLine"></lineSvg>
                </div>
              </div>
              <div class="bgClass g-column-flex-HV"
                ...
                物联网平台
                <lineSvg style="left:120px;top: 0px" svgWidth="206px" :svgHeight="wwLink"
                  setPoints="0,20 200,20 200,263 "></lineSvg>
              </div>
            </div>
          ...
          <div style="height: 33%; position: relative" class="g-row-flex-V">
            ...
            <div class="g-row-flex-V"
              ...
              <div class="g-column-flex-V" style="height: calc(100% - 30px);">
                <div class="typeClass g-row-flex-V" v-for="(item, index2) in initJptList" :key="index2"
                  ...
                  <lineSvg style="top:5px;z-index:0;"
                    :setPoints="index2 === 0 ? topLine : index2 === 1 ? '0,20 180,20 180,19 180,30 258,30' : index2 === 2 ? '0,20 180,20 180,19 180,5 258,5' : ''">
                  </lineSvg>
              ...
              <div class="bgClass g-column-flex-HV"
                ...
                :style="{ background: $store.state.setting.mode === 'dark' ? 'rgba(0,100,169,0.3)' : '#183C5B' }">
                物联网平台
                <lineSvg style="left:120px;top: 0px" svgWidth="155px" svgHeight="50px" setPoints="0,23 155,23 155,21 ">
                </lineSvg>
            ...
            <div class="g-row-flex-V"
              ...
              <div class="g-column-flex-V" style="height: calc(100% - 30px)">
                <div class="typeClass g-row-flex-V" v-for="(item, index3) in resultFPSOptList" :key="index3">
                  <div class="bgClass g-row-flex-V g-w100 g-h100"
                    :style="{ background: $store.state.setting.mode === 'dark' ? 'rgba(0,169,159,0.3)' : 'rgba(0,169,159,0.5)' }"
                    style="cursor: pointer" @click="clickItem(item, '工作项')">
                    <div class="circleStyle" :style="{ background: item.isGreen ? '#309800' : '#FF4D4F' }"></div>
                    <svg-icon v-if="item.icon" class="svgIconClass" :icon-class="item.icon" style="margin-right:6px" />
                    {{ item.name }}
                  </div>
                  <lineSvg style="top:5px;z-index:0;"
                    :setPoints="index3 === 0 ? topLine : index3 === 1 ? '0,20 180,20 180,19 180,30 258,30' : index3 === 2 ? '0,20 180,20 180,19 180,5 258,5' : ''">
                  </lineSvg>
              ...
              <div class="bgClass g-column-flex-HV"
                ...
                :style="{ background: $store.state.setting.mode === 'dark' ? 'rgba(0,100,169,0.3)' : '#183C5B' }">
                物联网平台
                <lineSvg style="left:120px;" :style="{ top: wwlinkTop }" svgWidth="206px" :svgHeight="wwLink"
                  :setPoints="wwLinkLine"></lineSvg>
              </div>
            </div>
            <div class="absoulteDiv">
              <div class="bgClass g-row-flex-V g-w100 g-h100" style="cursor: pointer;position: relative;z-index:1"
                :style="{ background: $store.state.setting.mode === 'dark' ? 'rgba(0,169,159,0.3)' : 'rgba(0,169,159,0.5)' }"
      ...
      <div style="height: calc(100% - 0px)" class="g-column-flex rightBgStyle">
        ...
        <div class="g-row-flex-V g-h100 g-w100">
          ...
          <div style="width: 78%" class="g-h100 g-column-flex">
            <div class="g-row-flex-V" style="height: 30%;position: relative;">
              <div class="pageGreen g-column-flex-HV" style="margin-right: 26px"
                :style="{ background: $store.state.setting.mode === 'dark' ? 'rgba(45,141,92,0.3)' : 'rgba(45,141,92,0.6)' }">
                <div style="margin-bottom: 10px">页面</div>
                <div class="greenBtn g-column-flex-HV">报警及实时数据展示</div>
              </div>
              <lineSvg style="left:20px;z-index:0" svgWidth="135px" :style="{ top: fyLinkTop }" :svgHeight="fyLinkHeight"
                :setPoints="fyPoint"></lineSvg>
              <lineSvg style="left:20px;z-index:0" svgWidth="300px" :style="{ top: fyLinkTop }" :svgHeight="fyLinkHeight"
                setPoints="65,20 295,20 295,0"></lineSvg>
              <lineSvg style="left:255px;z-index:0" svgWidth="400px" :style="{ top: fyLinkTop }" :svgHeight="fyLinkHeight"
                setPoints="65,20 175,20 175,0"></lineSvg>
              <lineSvg style="left:335px;z-index:0" svgWidth="400px" :style="{ top: fyLinkTop }" :svgHeight="fyLinkHeight"
                setPoints="100,20 215,20 215,0"></lineSvg>


              <div class="menOrange g-column-flex-HV"
                :style="{ background: $store.state.setting.mode === 'dark' ? 'rgba(211,90,32,0.3)' : 'rgba(211,90,32,0.6)' }">
            ...
            <div class="g-row-flex-V" style="height: 40%">
              <div class="g-column-flex" style="margin: 0 159px 120px 20px;position: relative;">
                <div class="blueBtn g-column-flex-HV" style="width: 140px; margin-bottom: 77px;cursor: pointer"
                  @click="clickItem('', 'Flink集群')"
                  :style="{ background: $store.state.setting.mode === 'dark' ? 'rgba(36,222,255,0.5)' : '#085296' }">
                  Flink集群</div>
                <lineSvg style="left:0px;top: 44px;z-index:0" svgWidth="135px" svgHeight="78px"
                  setPoints="65,77 65,0 64,0"></lineSvg>
                <lineSvg style="left:140px;top: 0px;z-index:0" svgWidth="155px" svgHeight="78px"
                  setPoints="0,23 155,23 155,22"></lineSvg>
                <lineSvg style="left:140px;top: 23px;z-index:0" svgWidth="155px" svgHeight="78px"
                  setPoints="77,0 77,70 155,70"></lineSvg>
                <lineSvg style="left:140px;top: 96px;z-index:0" svgWidth="155px" svgHeight="78px"
                  setPoints="77,0 77,70 155,70"></lineSvg>
                <div class="blueBtn g-column-flex-HV" style="width: 140px"
                  :style="{ background: $store.state.setting.mode === 'dark' ? 'rgba(36,222,255,0.5)' : '#085296' }">
                  Kafks集群</div>
              </div>
              <div class="blueBg g-column-flex-HV"
                :style="{ background: $store.state.setting.mode === 'dark' ? 'rgba(36,222,255,0.2)' : 'rgba(8,82,150,0.3)' }">
                <div class="blueBtn g-row-flex-HV" style="width: 154px"
                  :style="{ background: $store.state.setting.mode === 'dark' ? 'rgba(36,222,255,0.5)' : '#085296' }">
                ...
                <div class="blueBtn g-row-flex-HV" style="width: 154px; margin: 20px 0"
                  :style="{ background: $store.state.setting.mode === 'dark' ? 'rgba(36,222,255,0.5)' : '#085296' }">
                <!-- <img class="dataBase" src="../../../assets/intelligentOilfield/dataBase.png" alt=""
                      style="margin-right: 3px" /> -->
                  <svg-icon class="svgIconClass" icon-class="data" style="margin-right:6px" />
                ...
                <div class="g-column-flex-HV blueBtn" style="width: 154px; height: 144px"
                  :style="{ background: $store.state.setting.mode === 'dark' ? 'rgba(36,222,255,0.5)' : '#085296' }">
            ...
            <div class="g-row-flex-V" style="height: 30%">
              <div style="width: 386px; height: 119px" class="blueBg g-row-flex-HV"
                :style="{ background: $store.state.setting.mode === 'dark' ? 'rgba(36,222,255,0.2)' : 'rgba(8,82,150,0.3)' }">
                <div class="blueBtn" style="height: 79px; margin-right: 66px"
                  :style="{ background: $store.state.setting.mode === 'dark' ? 'rgba(36,222,255,0.5)' : '#085296' }">
                ...
                <div class="blueBtn g-row-flex-HV"
                  :style="{ background: $store.state.setting.mode === 'dark' ? 'rgba(36,222,255,0.5)' : '#085296' }">
                <!-- <img class="dataBase" src="../../../assets/intelligentOilfield/dataBase.png" alt=""
                      style="margin-right: 3px" /> -->
                  <svg-icon class="svgIconClass" icon-class="data" style="margin-right:6px" />
        ...
        <div style="margin: 0px 0 20px 36px;font-size:14px" class="g-row-flex-V">
          ...
          <div style="margin-right: 10px" :style="{ color: $store.state.setting.mode === 'dark' ? '#fff' : '#909399' }">一库
          </div>
