    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24" class="right">
        <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
          ...
          <el-form-item>
            <el-button type="primary" icon="el-icon-search" size="mini" @click="handleQuery" style="height: 40px"
              >搜索</el-button
            >
        ...
        <el-row :gutter="10" class="mb8">
          ...
          <el-col :span="1.5">
            <el-button class="commonBtn" size="mini" @click="handleImport" v-hasPermi="['system:user:import']"
              >导入</el-button
            >
          </el-col>
          <el-col :span="1.5">
...
export default {
  ...
  methods: {
    ...
    seeDetail(row) {
      ...
      this.$router.push({
        name: `userDetail`,
        query: { userId: tempUserId, postName: row.posts[0]?.postName, userName: row.userName },
      });
