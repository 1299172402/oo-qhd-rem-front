...
<template>
  <div class="app-container">
    ...
    <page-panel-new header-title="应用数据权限列表" style="height: calc(100% - 165px);">
    ...
    >
          ...
          <el-col :span="12">
            <el-form-item label="应用选择" prop="appId">
              <el-select
                ...
                placeholder="请选择应用"
                clearable
                @change="gettableList(addform.appId)"
              >
                <el-option
                  v-for="(item, index) in appSelect"
                  :key="index"
          ...
          <el-col :span="12">
            <el-form-item label="列表选择" prop="tableId">
              <el-select
                ...
                placeholder="请选择列表"
                clearable
                @change="getfieldsList(addform.tableId)"
              >
                <el-option
                  v-for="(item, index) in ulSelect"
                  :key="index"
      ...
      <div slot="footer" class="dialog-footer">
        <el-button v-if="title == '新增数据权限' ? 1 : 0" type="primary" @click="submitForm">
          确 定
        </el-button>
        <el-button v-else type="primary" @click="editForm">
          确 定
        </el-button>
...
import {
  ...
  updatePer,
  changeDataStatus
} from "@/api/intelligentOilfield/system/dataper";
