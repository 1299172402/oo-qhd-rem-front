...
const GenerateRouter = {
  ...
  "FlowModel": () => import("@/pages/horizontalWell/flowmodel"),
  "Forewarning": () => import("@/pages/horizontalWell/forewarning"),
  "CompartmentDesign": () => import("@/pages/horizontalWell/compartmentdesign"),
