...
define([
    ...
    Com.WGADPlatComFrame = function (viewSetting, contentWindow) {
            ...
            if (data.Layers) {
                ...
                for (var i = 0; i < data.Layers.length; i++) {
                    ...
                    if (layer.LayerType == WGADPlatGraph2DFrame.EWGFrameLayerType.fltWellLog) {
                        ...
                        if (data.Layers[i].WellDotInfo && data.Layers[i].WellDotInfo.length > 0) {
                            ...
                            for (var index = 0; index < data.Layers[i].WellDotInfo.length; index++) {
                                ...
                                if (
                                    wellDotInfo.Label &&
                                    wellDotInfo.Label.length > 0 &&
                                    wellDotInfo.WellDotTypeCode != undefined
                                ) {
                                    ...
                                    for (var labelIndex = 0; labelIndex < wellDotInfo.Label.length; labelIndex++) {
                                        ...
                                        if (label.ViewPen) {
                                            ...
                                            if (
                                                viewPen.PenColorA != undefined &&
                                                viewPen.PenColorR != undefined &&
                                                viewPen.PenColorG != undefined &&
                                                viewPen.PenColorB != undefined
                                            ) {
                                                labelDic["ViewPen"].PenColor = WGADPlatGMEngine.WGColor.FromARGB(
                                                    viewPen.PenColorA,
                                                    viewPen.PenColorR,
                                                    viewPen.PenColorG,
                                                    viewPen.PenColorB
                                        ...
                                        if (label.ViewBrush) {
                                            ...
                                            labelDic["ViewBrush"] =
                                                wellTemplate.Childrens[labelIndex].ViewBrush.Clone();
                                            if (
                                                viewBrush.BrushColorA != undefined &&
                                                viewBrush.BrushColorR != undefined &&
                                                viewBrush.BrushColorG != undefined &&
                                                viewBrush.BrushColorB != undefined
                                            ) {
                                                labelDic["ViewBrush"].Color = WGADPlatGMEngine.WGColor.FromARGB(
                                                    viewBrush.BrushColorA,
                                                    viewBrush.BrushColorR,
                                                    viewBrush.BrushColorG,
                                                    viewBrush.BrushColorB
                                                );
                                            }
                                        ...
                                        if (label.Font) {
                                            ...
                                            if (font.Color) {
                                                ...
                                                if (
                                                    color.ColorA != undefined &&
                                                    color.ColorR != undefined &&
                                                    color.ColorG != undefined &&
                                                    color.ColorB != undefined
                                                ) {
                                                    labelDic["Font"].Color = WGADPlatGMEngine.WGColor.FromARGB(
                                                        color.ColorA,
                                                        color.ColorR,
                                                        color.ColorG,
                                                        color.ColorB
                    ...
                    for (var j = 0; j < data.Layers[i].Objects.length; j++) {
                        ...
                        var expInfo = data.Layers[i].ExpInfo;
                        switch (itemObject.ObjType) {
                            ...
                            case WGADPlatGraph2D.EWGObjectType.wgtFrameExploitation: {
                                ...
                                if (itemObject.MinHisHeight != undefined) {
                                    exp.MinHisHeight = itemObject.MinHisHeight;
                                }
                                if (itemObject.MaxHisHeight != undefined) {
                                    exp.MaxHisHeight = itemObject.MaxHisHeight;
                                }
                                if (itemObject.MinHisValue != undefined) {
                                    exp.MinHisValue = itemObject.MinHisValue;
                                }
                                ...
                                if (itemObject.OffX1 != undefined) {
                                    exp.OffX1 = itemObject.OffX1;
                                }
                                if (itemObject.OffY1 != undefined) {
                                    exp.OffY1 = itemObject.OffY1;
                                }
                                ...
                                if (itemObject.PositionX != undefined) {
                                    exp.PositionX = itemObject.PositionX;
                                }
                                if (itemObject.PositionY != undefined) {
                                    exp.PositionY = itemObject.PositionY;
                                }
                                if (itemObject.Histogram2 != undefined) {
                                    for (var m = 0; m < itemObject.Histogram2.length; m++) {
                                        var obj = itemObject.Histogram2[m];
                                        var expInfoItem = expInfo.Histogram[m];
                                        var expHis = new WGADPlatGraph2DFrame.WGFrameExploitationHistogram({});
                                        //用前面的设置
                                        expHis.ParentExploitation = exp;
                                        // expHis.JsonObjLoad(expInfoItem);
                                        if (expInfo.HistogramDecimals) {
                                            expHis.HistogramDecimals = expInfo.HistogramDecimals;
                                        }
                                        if (expInfoItem.ViewPen) {
                                            expHis.ViewPen = WGADPlatGMEngineTools.WGJsonObjPersistence.JsonToPen(
                                                expInfoItem.ViewPen
                                            );
                                        } else {
                                        ...
                                        if (expInfoItem.ViewBrush) {
                                            expHis.ViewBrush = WGADPlatGMEngineTools.WGJsonObjPersistence.JsonToBrush(
                                                expInfoItem,
                                                "ViewBrush"
                                            );
                                        } else {
                                        ...
                                        if (expInfoItem.ShowText != undefined && !expInfoItem.ShowText) {
                                            ...
                                            if (expInfoItem.OffX) {
                                                expText.OffX1 = expInfoItem.OffX;
                                            }
                                            if (expInfoItem.OffY) {
                                                expText.OffY1 = expInfoItem.OffY;
                                            }
                                            if (expInfo.Font) {
                                                expText.Font = WGADPlatGMEngineTools.WGJsonObjPersistence.JsonToFont(
                                                    expInfo,
                                                    "Font"
                                                );
                                            }
                                            if (expInfoItem.Font) {
                                                var font = expInfoItem.Font;
                                                if (font.FontName != undefined) {
                                                    expText.Font.FontName = font.FontName;
                                                }
                                                if (font.FontSize > 0) {
                                                    expText.Font.FontSize = font.FontSize;
                                                }
                                                if (font.Weight != undefined) {
                                                    expText.Font.Weight = font.Weight;
                                                }
                                                if (font.Color) {
                                                    var color = font.Color;
                                                    if (
                                                        ...
                                                        expText.Font.Color = WGADPlatGMEngine.WGColor.FromARGB(
                                                            color.ColorA,
                                                            color.ColorR,
                                                            color.ColorG,
                                                            color.ColorB
                                            ...
                                            if (obj.OffX) {
                                                expText.OffX1 = obj.OffX;
                                            }
                                            if (obj.OffY) {
                                                expText.OffY1 = obj.OffY;
                                            }

                                            expHis.AddChildren(expText);
                                        }
                                        if (obj.HintText) {
                                            expHis.CustomHintText = obj.HintText;
                                        }
                                        ...
                                        if (obj.Text) {
                                            ...
                                            expHis.Text = expInfoItem.Text;
                                        }
                                        if (obj.Code) {
                                            expHis.Code = obj.Code;
                                        }else {
                                            expHis.Code = expInfoItem.Code;
                                        }
                                        if (obj.Height != undefined) {
                                            expHis.Height = obj.Height;
                                        } else {
                                            if (
                                                exp.MaxHisHeight != undefined &&
                                                exp.MinHisHeight != undefined &&
                                                exp.MaxHisValue != undefined &&
                                                exp.MinHisValue != undefined
                                            ) {
                                                if (exp.MaxHisHeight - exp.MinHisHeight < 1e-3) {
                                                    expHis.Height = exp.MinHisHeight;
                                                } else {
                                                    if (obj.Value >= exp.MinHisValue && obj.Value <= exp.MaxHisValue) {
                                                        expHis.Height =
                                                            ((obj.Value - exp.MinHisValue) *
                                                                (exp.MaxHisHeight - exp.MinHisHeight)) /
                                                                (exp.MaxHisValue - exp.MinHisValue) +
                                                            exp.MinHisHeight;
                                                    } else {
                                                        if (obj.Value < exp.MinHisValue) {
                                                            expHis.Height = exp.MinHisHeight;
                                                        } else {
                                                            expHis.Height = exp.MaxHisHeight;
                                                        }
                                                    }
                                                }
                                            } else {
                                                if (exp.MaxHisHeight != undefined && exp.MaxHisValue != undefined) {
                                ...
                                if (itemObject.Pie2 != undefined) {
                                    for (var m = 0; m < itemObject.Pie2.length; m++) {
                                        var obj = itemObject.Pie2[m];
                                        var expPie = new WGADPlatGraph2DFrame.WGFrameExploitationPie({});
                                        var expInfoItem = expInfo.Pie[m];
                                        expPie.ParentExploitation = exp;
                                        // expPie.JsonObjLoad(expInfoItem);
                                        if (expInfo.PieDecimals) {
                                            expPie.PieDecimals = expInfo.PieDecimals;
                                        }
                                        if (expInfoItem.ViewPen) {
                                            expPie.ViewPen = WGADPlatGMEngineTools.WGJsonObjPersistence.JsonToPen(
                                                expInfoItem.ViewPen
                                            );
                                        } else {
                                        ...
                                        if (expInfoItem.ViewBrush) {
                                            expPie.ViewBrush = WGADPlatGMEngineTools.WGJsonObjPersistence.JsonToBrush(
                                                expInfoItem,
                                                "ViewBrush"
                                            );
                                        } else {
                                        ...
                                        if (obj.Text) {
                                            ...
                                            expPie.Text = expInfoItem.Text;
                                        }
                                        if (obj.Code) {
                                            expPie.Code = obj.Code;
                                        }else {
                                            expPie.Code = expInfoItem.Code;
                                        }
                                        expPie.Value = obj.Value;
                                        if (obj.HintText) {
                                            expPie.CustomHintText = obj.HintText;
                                        }
                                ...
                                if (itemObject.Histogram != undefined) {
                                    this.RemoveChildrenByType(
                                        exp.Childrens,
                                        WGADPlatGraph2D.EWGObjectType.wgtFrameExploitationHistogram
                                    );
                                ...
                                if (itemObject.Pie != undefined) {
                                    this.RemoveChildrenByType(
                                        exp.Childrens,
                                        WGADPlatGraph2D.EWGObjectType.wgtFrameExploitationPie
                                    );
        ...
        this.RemoveChildrenByType = function (childrens, type) {
                ...
                if (
                    ...
                    if (comSelf.rangeSegY.seismicMainMap.MapBoundEarth.IsInPolygon(eX, eY)) {
                        ...
                        if (seismicLine) {
                            ...
                            var point = new WGADPlatGMEngine.WGPoint(); //坐标点
                            point.Init(eX, eY);
                            point = point.TransformData(comSelf.View.MapData.Transform.GetEarthToMapMatrix());
                            comSelf.rangeSegY.seismicMainMap.DrawDot(canvas, point, seismicLine, true);
                            // console.log("aa");
                        }
                    }
                }
        ...
        this.MouseFolow = function () {
            ...
            if (comSelf.rangeSegY.seismicMainMap) {
                var seismicLine = comSelf.SelectSeismicLine;
                if (seismicLine) {
                    // this.direction=seismicLine.Tag.toString();
        ...
        this.AutoFollowDraw = function (inline, crossline) {
            ...
            // comSelf.rangeSegY.seismicMainMap.IsDrawMarker = true;
            comSelf.rangeSegY.seismicMainMap.DrawDot(canvas, point, null, false);
        };
        //取消自动标记绘制
        ...
        this.View.EventObjectSeismicPLineDraw = function (e) {
            ...
            var layer = comSelf.View.MapData.GetLayerByName("测网图层");
            if (layer != null && layer) {
                layer.Actived = false;
            }
            comSelf.View.Repaint();
