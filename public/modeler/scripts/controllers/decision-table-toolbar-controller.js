...
angular.module('flowableModeler')
  .controller('DecisionTableToolbarController', ['$scope', '$http', '$modal', '$q', '$rootScope', '$translate', '$location', 'DecisionTableService',
    function ($scope, $http, $modal, $q, $rootScope, $translate, $location, DecisionTableService) {
    	...
    	const toolbarItems = DECISION_TABLE_TOOLBAR_CONFIG.items;
      $scope.items = [];
      ...
      $scope.toolbarButtonClicked = function(buttonIndex) {
        ...
        const services = { '$scope' : $scope, '$rootScope' : $rootScope, '$http' : $http, '$modal' : $modal, '$q' : $q, '$translate' : $translate, 'DecisionTableService': DecisionTableService};
      ...
      $scope.toolbarSecondaryButtonClicked = function(buttonIndex) {
        ...
        const services = { '$scope' : $scope, '$rootScope' : $rootScope, '$http' : $http, '$modal' : $modal, '$q' : $q, '$translate' : $translate, '$location': $location, 'DecisionTableService': DecisionTableService };
        executeFunctionByName(buttonClicked.action, window, services);
      };
    }]);