...
(function($, window) {
  ...
  Tour = (function() {
    ...
    Tour.prototype.hideStep = function(i) {
      let hideStepHelper; let promise; let step;
      step = this.getStep(i);
      if (!step) {
        return;
      }
    ...
    Tour.prototype.showStep = function(i) {
      let promise; let showStepHelper; let skipToPrevious; let step;
      if (this.ended()) {
      ...
      showStepHelper = (function(_this) {
        return function(e) {
          ...
          _this._scrollIntoView(step.element, () => {
    ...
    Tour.prototype._showNextStep = function() {
      let promise; let showNextStepHelper; let step;
      step = this.getStep(this._current);
    ...
    Tour.prototype._showPrevStep = function() {
      let promise; let showPrevStepHelper; let step;
      step = this.getStep(this._current);
    ...
    Tour.prototype._showPopover = function(step, i) {
      let $element; let $navigation; let $template; let $tip; let isOrphan; let options;
    ...
    Tour.prototype._reposition = function($tip, step) {
      let offsetBottom; let offsetHeight; let offsetRight; let offsetWidth; let originalLeft; let originalTop; let tipOffset;
    ...
    Tour.prototype._scrollIntoView = function(element, callback) {
      let $element; let $window; let counter; let offsetTop; let scrollTop; let windowHeight;
      $element = $(element);
      if (!$element.length) {
        return callback();
      }
    ...
    Tour.prototype._showOverlayElement = function(element) {
      let $background; let $element; let offset;
      $element = $(element);
