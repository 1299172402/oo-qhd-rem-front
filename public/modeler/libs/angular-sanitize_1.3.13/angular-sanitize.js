 ...
 */
  ...
  const optionalEndTagInlineElements = makeMap("rp,rt");
  const optionalEndTagElements = angular.extend({},
    optionalEndTagInlineElements,
    optionalEndTagBlockElements);

  // Safe Block Elements - HTML5
  const blockElements = angular.extend({}, optionalEndTagBlockElements, makeMap("address,article," +
        "aside,blockquote,caption,center,del,dir,div,dl,figure,figcaption,footer,h1,h2,h3,h4,h5," +
        "h6,header,hgroup,hr,ins,map,menu,nav,ol,pre,script,section,table,ul"));

  // Inline Elements - HTML5
  const inlineElements = angular.extend({}, optionalEndTagInlineElements, makeMap("a,abbr,acronym,b," +
        "bdi,bdo,big,br,cite,code,del,dfn,em,font,i,img,ins,kbd,label,map,mark,q,ruby,rp,rt,s," +
        "samp,small,span,strike,strong,sub,sup,time,tt,u,var"));

  // SVG Elements
  // https://wiki.whatwg.org/wiki/Sanitization_rules#svg_Elements
  const svgElements = makeMap("animate,animateColor,animateMotion,animateTransform,circle,defs," +
  ...
  const validElements = angular.extend({},
    voidElements,
    blockElements,
    inlineElements,
  ...
  const validAttrs = angular.extend({},
    uriAttrs,
    svgAttrs,
    htmlAttrs);
 ...
 */
  function htmlParser(html, handler) {
    ...
    let index; let chars; let match; const stack = []; let last = html; let text;
 ...
 */
  function decodeEntities(value) {
    ...
    const parts = spaceRe.exec(value);
    const spaceBefore = parts[1];
    const spaceAfter = parts[3];
    let content = parts[2];
    if (content) {
