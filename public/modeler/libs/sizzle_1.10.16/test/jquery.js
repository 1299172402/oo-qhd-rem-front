 ...
 */
  ...
  jQuery.support = (function() {
    ...
    let support; let all; let a;
    let input; let select; let fragment;
    let opt; let eventName; let isSupported; let i;
 ...
 */
    ...
    function siblingCheck( a, b ) {
      let cur = b && a;
      const diff = cur && ( ~b.sourceIndex || MAX_NEGATIVE ) - ( ~a.sourceIndex || MAX_NEGATIVE );
 ...
 */
  ...
  function getAll( context, tag ) {
    let elems; let elem;
    let i = 0;
    let found = typeof context.getElementsByTagName !== core_strundefined ? context.getElementsByTagName( tag || "*" ) :
 ...
 */
  ...
  function ajaxConvert( s, response ) {
    let conv2; let current; let conv; let tmp;
    const converters = {};
    let i = 0;
        ...
        return {
          send( headers, complete ) {
            ...
            callback = function( _, isAbort ) {
              let status; let responseHeaders; let statusText; let responses;
  ...
  function propFilter( props, specialEasing ) {
    let value; let name; let index; let easing; let hooks;
  ...
  function defaultPrefilter( elem, props, opts ) {
    ...
    let prop; let index; let length;
    let value; let dataShow; let toggle;
    let tween; let hooks; let oldfire;
    const anim = this;
    const {style} = elem;
    const orig = {};
    const handled = [];
