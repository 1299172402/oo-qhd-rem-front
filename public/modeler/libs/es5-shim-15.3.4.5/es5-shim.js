 ...
 */
  ...
  if (!Function.prototype.bind) {
    Function.prototype.bind = function bind(that) { // .length is 1
      ...
      const args = _Array_slice_.call(arguments, 1); // for normal call
  ...
  if ([1,2].splice(0).length != 2) {
    ...
    if(function() { // test IE < 9 to splice bug - see issue #138
      ...
      Array.prototype.splice = function(start, deleteCount) {
        let result
          ; const args = _Array_slice_.call(arguments, 2)
          ; const addElementsCount = args.length
            ;
  ...
  if (
    ...
    Date.prototype.toISOString = function toISOString() {
      let result; let length; let value; let year; let month;
      if (!isFinite(this)) {
  ...
  let dateToJSONIsSupported = false;
  try {
  ...
  if (!Number.prototype.toFixed || (0.00008).toFixed(3) !== '0.000' || (0.9).toFixed(0) === '0' || (1.255).toFixed(2) !== '1.25' || (1000000000000000128).toFixed(0) !== "1000000000000000128") {
    ...
    (function () {
      let base; let size; let data; let i;
  ...
  if (
    ...
    (function () {
      const compliantExecNpcg = /()??/.exec("")[1] === void 0; // NPCG: nonparticipating capturing group
      ...
      String.prototype.split = function (separator, limit) {
        ...
        let separator2; let match; let lastIndex; let lastLength;
        string += ""; // Type-convert
  ...
  if("".substr && "0b".substr(-1) !== "b") {
    const string_substr = String.prototype.substr;
    /**
  ...
  function toPrimitive(input) {
    let val; let valueOf; let toString;
