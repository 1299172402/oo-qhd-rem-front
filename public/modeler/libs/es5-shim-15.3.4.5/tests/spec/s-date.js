describe('Date', () => {
  ...
  describe("parse", () => {
    ...
    it('should support extended years', () => {
    ...
    it("should be able to coerce to a number", ()=> {
  ...
  describe("toString", ()=> {
    ...
    it(`should show correct date info for ${actual}`, ()=> {
  ...
  describe("toJSON", () => {
    ...
    it('should return null for not finite dates', () => {
    ...
    it('should return the isoString when stringified', () => {
      const date = new Date();
