...
var CustomStyle = (function CustomStyleClosure() {
  ...
  CustomStyle.getProp = function get(propName, element) {
    ...
    var style = element.style; var prefixed; var uPropName;
...
function getVisibleElements(scrollEl, views, sortByVisibility) {
  var top = scrollEl.scrollTop; var bottom = top + scrollEl.clientHeight;
  var left = scrollEl.scrollLeft; var right = left + scrollEl.clientWidth;
...
var PDFDocumentProperties = (function PDFDocumentPropertiesClosure() {
  ...
  PDFDocumentProperties.prototype = {
    ...
    _parseFileSize: function PDFDocumentProperties_parseFileSize() {
      var fileSize = this.rawFileSize; var kb = fileSize / 1024;
      if (!kb) {
        return;
      } else if (kb < 1024) {
...
var TextLayerBuilder = (function TextLayerBuilderClosure() {
  ...
  TextLayerBuilder.prototype = {
    ...
    renderMatches: function TextLayerBuilder_renderMatches(matches) {
      ...
      var i0 = selectedMatchIdx; var i1 = i0 + 1;
      if (highlightAll) {
        i0 = 0;
        i1 = matches.length;
...
var PDFViewer = (function pdfViewer() {
  ...
  PDFViewer.prototype = /** @lends PDFViewer.prototype */{
    ...
    _setScaleUpdatePages: function pdfViewer_setScaleUpdatePages(
      ...
      if (!noScroll) {
        var page = this._currentPageNumber; var dest;
    ...
    scrollPageIntoView: function PDFViewer_scrollPageIntoView(pageNumber,
      ...
      var x = 0; var y = 0;
      var width = 0; var height = 0; var widthScale; var heightScale;
...
var PDFViewerApplication = {
  ...
  download: function pdfViewDownload() {
    ...
    var filename = getPDFFileNameFromURL(url, filename);
